...
const DetailsDisplayUI: React.FC<DetailsDisplayUIProps> = ({
    ...
    const renderContent = () => {
        if (log.splitSummary) {
            ...
            return (
                <div>
                    ...
                    <p>Total Duplicates Found: {duplicateEntries.reduce((acc, entry) => acc + entry.count - 1, 0)}</p>
                    <button onClick={toggleExpansion}>
                        {isExpanded ? "Hide Details" : "Show Details"}
                    </button>
                    {isExpanded && (
        ...
        } else if (log.transferredCount !== undefined && log.documents !== undefined) {
            return (
                <div>
        ...
        } else if (log.updatedFolioRows !== undefined && log.updatedTransactionRows !== undefined) {
            return (
                <div>
