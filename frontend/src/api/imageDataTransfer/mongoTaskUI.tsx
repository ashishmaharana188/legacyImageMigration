  ...
  return (
      <div className="border border-gray-300 rounded-lg p-4 flex flex-col justify-between h-full bg-white shadow-sm">
            <div>
              ...
              <div className="mb-4">
                <label htmlFor="clientCode" className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1">
                ...
                <input
                  ...
                  className={`mt-1 block w-full rounded-md shadow-sm sm:text-sm p-2 border ${
                    isDirectModeInvalid ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:border-indigo-500 focus:ring-indigo-500"
                  }`}
                  value={clientCode}
